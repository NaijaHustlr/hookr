...
const ModelCardSmall: React.FC<{ model: ModelType }> = ({ model }) => {
  return (
...
const ModelCardRound: React.FC<{ model: ModelType }> = ({ model }) => {
  return (
...
const CategoryRow: React.FC<{ title: string; models: ModelType[] }> = ({ title, models }) => {
  return (
    <div className="mt-6">
