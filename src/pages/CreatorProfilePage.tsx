  ...
  return <div className="flex flex-col min-h-screen bg-hookr-dark pb-20">
      ...
      <div className="px-4 -mt-16 relative z-20">
        ...
        <div className="flex gap-2 mb-6">
          ...
          <Button variant="outline" className="border-hookr-accent text-hookr-accent flex-1 rounded-full hover:bg-hookr-accent hover:bg-opacity-10" onClick={handleUnlockContent}>
        ...
        <Tabs defaultValue="gallery" value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <TabsContent value="gallery" className="mt-4">
            <div className="grid grid-cols-2 gap-2">
              {creator.posts?.map(post => <Card key={post.id} className={`bg-hookr-muted border-hookr-muted overflow-hidden relative ${post.isPremium ? "opacity-60" : ""}`}>
                  <div className="relative aspect-square">
                    <img src={post.mediaUrl} alt={post.content} className="object-cover w-full h-full" />
                    {post.isPremium && <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
